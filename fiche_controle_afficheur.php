...
<TABLE BORDER="1" WIDTH="100%" style="background:aliceblue"> 
 ...
 <IMG id="logo3" class="logo3"SRC="images/logo3.jpg"  />
	<h2>Constat de vérification semestriel des Afficheurs</h2>
	<div id="tete2">
...
// recup dans etendue les données corespondant a etend
...
$reponse = $bdd->query('SELECT * FROM liste WHERE design ="Afficheur"');
...
{	  ?>
          ...
          <TR>
             <TD align="center"><?php echo "$rows[appli]";?></TD>
             ...
             <TD width="120px" align="center">+/- 5°C</TD>
			 <TD><?php echo "&nbsp;";?></TD>
             <TD><?php echo "&nbsp;";?></TD>
             <TD width="80px" align="center">+/- 0,5°C</TD>
			 <TD><?php echo "&nbsp;";?></TD>
             <TD><?php echo "&nbsp;";?></TD>
             <TD><?php echo "&nbsp;";?></TD>
          </TR>
