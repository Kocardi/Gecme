...
$sql=('UPDATE liste SET design = :design, marq = :marq, type = :type, ref = :ref, affec = :affec, appli = :appli, datepicker = :datepicker, datepicker2 = :datepicker2, etat = :etat, reso = :reso, etend = :etend, preci = :preci, etal = :etal, legal = :legal, plage = :plage, etal2 = :etal2, period = :period, tole = :tole, coef = :coef, erreur = :erreur, proced = :proced, commentaire = :commentaire WHERE ident = :ident');
$req = $bdd->prepare($sql);
$req->execute(array(
':design' => $design,
':marq' => $marq,
...
<script language="javascript">
  alert("<?php echo $design  ; ?> N°: <?php echo $ident ; ?>  Modifié !" );
