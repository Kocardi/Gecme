...
<TABLE BORDER="1" WIDTH="100%" style="background:aliceblue"> 
 ...
 <IMG id="logo3" class="logo3"SRC="images/logo3.jpg"  />
	<h2>Constat de vérification semestriel des Sondes de température GTC</h2>
	<div id="tete2">
...
$reponse = $bdd->query('SELECT * FROM liste WHERE design ="Sonde de température" AND appli ="GTC"');
...
{	  ?>	  
          <TR>
             ...
             <TD align="center">Température</TD>
...
<FORM>
	  ...
	  <form>  
        <input id="impression_gtc" name="impression" type="button" onclick="imprimer_page()" value="Imprimer fiche de contrôle"title="Imprime les fiches de vérification des sondes GTC" />
      </form>
